...
def gmap2alm(imap,lmax,healpix=False,iter=0):
...
def qe_tt_simple(Xmap,Ymap=None,lcltt=None,ucltt=None, \
                 ...
                 lmin=None,lmax=None,lmin_y=None,lmax_y=None,do_curl=False,mlmax=None,healpix=False):
    """
    ...
    if healpix:
        shape,wcs = enmap.fullsky_geometry(res=get_fullsky_res(npix=Xmap.size),proj="car")
    else:
