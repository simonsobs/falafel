...
sharp_src = process_cython_file('falafel/norm/norm.pyx')
...
setup(
    ...
    # },
    # ext_modules=[
    #     Extension('falafel.norm', sources=[sharp_src],
    #               **compile_opts),
    # ],
    ...
    name='falafel',
    packages=['falafel'],
    package_dir={'falafel':'falafel'},
    setup_requires=setup_requirements,
    test_suite='tests',
    tests_require=test_requirements,
    url='https://github.com/ACTCollaboration/falafel',
    version='0.1.0',
    zip_safe=False,
)
